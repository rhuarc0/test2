...
public class FetchQueueIds extends UseCase<List<String>, Void> {

    @Inject
    IBookRepository bookRepository;

    @Inject
    public FetchQueueIds(@Named(RxSchedulerModule.COMPUTATION) @NonNull Scheduler subscriberScheduler,
    ...
    protected Observable<List<String>> buildObservable(Void aVoid) {
        return bookRepository.fetchQueueBookIds();
    }
