...
public class PersistentSearchView extends RevealViewGroup {
    ...
    private OnSearchButtonListener mSearchButtonListener;
    ...
    public OnSearchButtonListener getSearchButtonListener() {
        return mSearchButtonListener;
    }

    public void setSearchButtonListener(OnSearchButtonListener searchButtonListener) {
        mSearchButtonListener = searchButtonListener;
    }
    ...
    private void search() {
        ...
        if (mSearchListener != null) mSearchListener.onSearch(searchTerm);
        if (mSearchButtonListener != null) mSearchButtonListener.onSearchButtonClick(searchTerm);
    ...
    private void fromEditingToSearch(boolean forceSearch, boolean avoidSearch) {
     ...
     //   closeSearchInternal();
        if (forceSearch && !avoidSearch) search();
    }
